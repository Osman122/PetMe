...
<FontAwesomeIcon onClick={"#"} className={`position-absolute fs-3 `} style={{ right: '12px', top: '15px', width:"20px",height:"20px", color:"#8c594d" ,borderRadius:"100px", padding:"3px"}} icon={faHeart}beat />
